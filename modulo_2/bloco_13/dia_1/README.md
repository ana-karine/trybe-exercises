...
![PR do exercício](exercise-dog-image/images/example-pr.png)

É necessário realizar uma mudança. Clique no *base repository* como na imagem abaixo:

![Mudando a base do repositório](exercise-dog-image/images/change-base.png)
...
![Após mudança](exercise-dog-image/images/after-change.png)
