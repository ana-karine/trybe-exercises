...
Critérios de aceite
a) Uma chamada bem-sucedida de uma função 'getChange' deve retornar uma lista com o valor das moedas que serão devolvidas à pessoa
b) Essa lista deve estar no formato decrescente de valor
c) É permitida a repetição do valor de moedas, por exemplo, '[200, 100, 50, 20, 10, 2, 2]'
d) Um erro com a mensagem 'paid value is not enough' deve ser lançado se o valor pago for menor que o valor da compra
...
a) 'payable' é o valor a ser pago, ou o valor total
b) 'paid' é o valor que a pessoa pagou
*/
